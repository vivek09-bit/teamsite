...
const Footer = () => {
  return (
    <footer className="bg-yellow-500 text-white p-4 md:p-6 mx-4 md:mx-10 my-4 rounded-2xl flex flex-col md:flex-row flex-wrap justify-center md:justify-between items-center shadow-lg">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col md:flex-row md:space-x-2 text-center md:text-left">
          <span className="text-xl md:text-2xl font-medium text-black">TEAM</span>
          <span className="text-xl md:text-2xl font-bold text-black">IGNITE</span>
        </div>
      </div>

      {/* Right Section: Credits */}
      <div className="flex flex-col md:flex-row items-center text-center mt-4 md:mt-0 gap-2 md:gap-4">
        <p className="text-sm md:text-lg font-semibold text-black flex items-center gap-2">
